	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(btn.equals("find")) {
				...
				for(Product p:plist) {  
					...
					out.println("<input type='checkbox' name='prod' id='p"+cnt+"' value='"+str+"'>
							// labeling is for when you click on name , the checkbox will get checked
							<label for='p"+cnt+"'>"+p.getPname()+"-----"+p.getPrice()+"<lable><br>");
					cnt++;
